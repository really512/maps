...
public class MainActivity extends Activity implements LocationListener {
    ...
    private TextView status; private long lastVoice=0;
    ...
    private void showRoute(){status.setText("🛣️ Маршрут готов • Нажмите «Включить навигатор»");
    ...
    private void toggleNav(boolean on){nav=on;status.setText(nav?"🔊 Навигатор ВКЛ • голосовые подсказки": "🔇 Навигатор ВЫКЛ • маршрут остаётся на карте");if(nav)speak("Навигатор включён");}
