...
public class MainActivity extends Activity implements LocationListener {
    ...
    private TextView status; private long lastVoice=0; private android.content.SharedPreferences navPrefs;
    ...
    private void showRoute(){ if(destination!=null) navPrefs.edit().putFloat("destination_lat",(float)destination.getLatitude()).putFloat("destination_lon",(float)destination.getLongitude()).putString("destination_title","Место назначения").apply(); status.setText("🛣️ Маршрут готов • Нажмите «Включить навигатор»");
